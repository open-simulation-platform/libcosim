...
find_library(PROXY_FMI_LIBRARY NAMES fmi)
mark_as_advanced(PROXY_FMI_LIBRARY)

find_library(PROXY_CLIENT_LIBRARY NAMES proxy-client)
mark_as_advanced(PROXY_CLIENT_LIBRARY)

include(FindPackageHandleStandardArgs)
FIND_PACKAGE_HANDLE_STANDARD_ARGS(PROXY_FMU
        REQUIRED_VARS PROXY_FMI_LIBRARY PROXY_CLIENT_LIBRARY PROXY_FMU_INCLUDE_DIR)
...
if (PROXY_FMU_FOUND)
  ...
  if (NOT PROXY_FMU_LIBRARIES)
    set(PROXY_FMU_LIBRARIES ${PROXY_FMI_LIBRARY} ${PROXY_CLIENT_LIBRARY})
  endif()
  ...
  if (NOT TARGET proxy-server)
    ...
    set_property(TARGET proxy-server APPEND PROPERTY
            IMPORTED_LOCATION "${PROXY_CLIENT_LIBRARY}")
  endif()
