 ...
 *  @generated
 */
#ifndef CSE_SERVICE_TYPES_HPP
#define CSE_SERVICE_TYPES_HPP
...
namespace fmuproxy {
    namespace thrift {
        ...
        typedef struct _ScalarVariableAttribute__isset {
            _ScalarVariableAttribute__isset() : integerAttribute(false), realAttribute(false), stringAttribute(false),
                                                booleanAttribute(false), enumerationAttribute(false) {}
        ...
        typedef struct _ScalarVariable__isset {
            _ScalarVariable__isset() : name(false), valueReference(false), description(false), initial(false),
                                       causality(false), variability(false), attribute(false) {}
        ...
        public:
            ...
            ScalarVariable()
                    : name(), valueReference(0), description(), initial((Initial::type) 0),
                      causality((Causality::type) 0), variability((Variability::type) 0) {
            }
        ...
        typedef struct _ModelDescription__isset {
            _ModelDescription__isset() : guid(false), fmiVersion(false), modelName(false), license(false),
                                         copyright(false), author(false), version(false), description(false),
                                         generationTool(false), generationDateAndTime(false), defaultExperiment(false),
                                         variableNamingConvention(false), modelVariables(false),
        ...
        public:
            ...
            ModelDescription()
                    : guid(), fmiVersion(), modelName(), license(), copyright(), author(), version(), description(),
                      generationTool(), generationDateAndTime(), variableNamingConvention() {
            }
            ...
            bool operator==(const ModelDescription &rhs) const {
                ...
                if (__isset.variableNamingConvention != rhs.__isset.variableNamingConvention)
                    return false;
                else if (__isset.variableNamingConvention &&
                         !(variableNamingConvention == rhs.variableNamingConvention))
                    return false;
        ...
        typedef struct _CoSimulationAttributes__isset {
            _CoSimulationAttributes__isset() : modelIdentifier(false), canGetAndSetFMUstate(false),
                                               canSerializeFMUstate(false), providesDirectionalDerivative(false),
                                               canHandleVariableCommunicationStepSize(false),
                                               canInterpolateInputs(false), maxOutputDerivativeOrder(false) {}
        ...
        public:
            ...
            CoSimulationAttributes()
                    : modelIdentifier(), canGetAndSetFMUstate(0), canSerializeFMUstate(0),
                      providesDirectionalDerivative(0), canHandleVariableCommunicationStepSize(0),
                      canInterpolateInputs(0), maxOutputDerivativeOrder(0) {
            }
